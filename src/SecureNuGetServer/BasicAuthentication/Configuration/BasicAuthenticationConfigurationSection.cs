...
namespace SecureNuGetServer.BasicAuthentication.Configuration
{
  public class BasicAuthenticationConfigurationSection : ConfigurationSection
  {
    ...
    {
      get => (bool) this["allowRedirects"];
      set => this["allowRedirects"] = value;
    }

    /// <summary>
    ///   Gets or sets a value indicating whether authenticaiton module should allow local requests without issuing auth
    ///   challenge.
    /// </summary>
    /// <value>
    ///   <c>true</c> to allow redirects; otherwise, <c>false</c>.
    ...
    {
      get => (ExcludeElementCollection) this[ExcludesNode];
